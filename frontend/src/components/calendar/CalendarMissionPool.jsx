...
function CalendarMissionPool({ onDragStartPoolMission, activeTagFilters, refreshTrigger }) {
    ...
    return (
        <div className="calendar-mission-pool-sidebar">
            ...
            {!isLoading && !error && poolMissions.length > 0 && (
                <ul className="pool-mission-list" style={{maxHeight: 'calc(100% - 70px)', overflowY: 'auto'}}> {/* Adjusted maxHeight */}
